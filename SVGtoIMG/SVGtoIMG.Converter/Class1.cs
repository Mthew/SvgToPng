...
namespace SVGtoIMG.Converter
{
    ...
    public class Converter
    {
        ...
        public void DrawFromSvg()
        {
            ...
            g.DrawString("Empacadorea y empaque SAS\nTICKETEVENTO NO SE HACE RESPONSABLE DE COMERCIALIZACIÓN DE ESTA ENTRADA".ToUpper(), new Font("Arial", 8, System.Drawing.FontStyle.Bold), new SolidBrush(Color.Black), 10f, 200f);
